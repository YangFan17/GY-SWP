...
export class TokenAuthServiceProxy {
    ...
    // test(loginTmpCode): Observable<ScanUserInfo> {
    //     let url_ = "https://oapi.dingtalk.com/connect/oauth2/sns_authorize?appid=dingoanherbetgt7ld5rrh&response_type=code&scope=snsapi_login&state=STATE&redirect_uri=http://localhost:21021/api/TokenAuth/AuthenticateByScanCodeAsync&loginTmpCode=" + loginTmpCode;
    //     console.log(url_);
    //     // url_ = url_.replace(/[?&]$/, "");
    //     let options_: any = {
    //         observe: "response",
    ...
    //             } catch (e) {
    //                 return <Observable<ScanUserInfo>><any>_observableThrow(e);
    //             }
    //         } else
    //             return <Observable<ScanUserInfo>><any>_observableThrow(response_);
    //     }));
    // }

    // protected processTest(response: HttpResponseBase): Observable<ScanUserInfo> {
    //     const status = response.status;
    //     const responseBlob =
    //         response instanceof HttpResponse ? response.body :
    //             (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    //             //         result200.push(ScanUserInfo.fromJS(item));
    //             // }
    //             // return _observableOf(result200);
    //             let result200: any = null;
    //             let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
    //             result200 = resultData200 ? ScanUserInfo.fromJS(resultData200) : new ScanUserInfo();
    //             return _observableOf(result200);
    //         }));
    //     } else if (status !== 200 && status !== 204) {
    //         return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    //         }));
    //     }
    //     return _observableOf<ScanUserInfo>(<any>null);
    // }
    // scanLogin(loginTmpCode): Observable<ScanUserInfo> {
    //     let url_ = this.baseUrl + "/api/TokenAuth/AuthenticateByScanCodeAsync123?";
    //     if (loginTmpCode !== undefined) {
    //         url_ += "loginTmpCode=" + encodeURIComponent("" + loginTmpCode) + "&";
    //     }
    //     url_ = url_.replace(/[?&]$/, "");
    //     let options_: any = {
    //         observe: "response",
    ...
    //     return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
    //         return this.processScanLogin(response_);
    //     })).pipe(_observableCatch((response_: any) => {
    //         if (response_ instanceof HttpResponseBase) {
    //             try {
    //                 return this.processScanLogin(<any>response_);
    //             } catch (e) {
    //                 return <Observable<ScanUserInfo>><any>_observableThrow(e);
    //             }
    //         } else
    ...
    // protected processScanLogin(response: HttpResponseBase): Observable<ScanUserInfo> {
    //     const status = response.status;
    //     const responseBlob =
    //         response instanceof HttpResponse ? response.body :
    //             (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ScanUserInfo implements IScanUserInfo {
    userName: string;
    password: string;
    constructor(data?: IScanUserInfo) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ScanUserInfo {
        data = typeof data === 'object' ? data : {};
        let result = new ScanUserInfo();
        result.init(data);
        return result;
    }
    toJSON(data?: any) {
