...
export class LoginComponent extends AppComponentBase implements OnInit {
  ...
  qrcode() {
    var obj = this.DDLogin({
      ...
      goto: encodeURIComponent('https://oapi.dingtalk.com/connect/qrconnect?appid=dingoanherbetgt7ld5rrh&response_type=code&scope=snsapi_login&state=STATE&redirect_uri=http://localhost:21021/home/AuthenticateByScanCodeAsync'), //请参考注释里的方式
  ...
  DDLogin(a) {
    ...
    var hanndleMessage = function (event) {
      ...
      if (origin == "https://login.dingtalk.com") { //判断是否来自ddLogin扫码事件。
        ...
        window.location.href = "https://oapi.dingtalk.com/connect/oauth2/sns_authorize?appid=dingoanherbetgt7ld5rrh&response_type=code&scope=snsapi_login&state=STATE&redirect_uri=http://localhost:21021/home/AuthenticateByScanCodeAsync&loginTmpCode=" + loginTmpCode
